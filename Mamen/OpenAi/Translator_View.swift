...
struct Translator_View: View {
            ...
            VStack(alignment: .leading){
                ...
                HStack(alignment: .center){
                    ...
                    Button(action: sendMessage) {
                        Image(systemName: typingMessage.isEmpty ? "circle.circle" : "text.magnifyingglass")
                            .resizable()
                            .fontWeight(.bold)
                            .scaledToFit()
    ...
    private func sendMessage() {
        ...
        let tempMessage = "Translate to Chinese: " + typingMessage
        typingMessage = ""
        hideKeyboard()
        Task{
...
struct Translator_View_Previews: PreviewProvider {
