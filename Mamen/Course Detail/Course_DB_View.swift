...
struct Course_DB_View: View {
    ...
    var body: some View {
        VStack {
            TeacherView(image: "maged", name: "Maged Refat", mail: "Maged@zy.edu.cn")
                .onTapGesture {
            ...
            VStack {
                ...
                ScrollView(showsIndicators: false){
                    VStack {
                        ZStack{
                            CourseFileView(image: "ZIP", name: "w11tutorialxslt-json.rar", time: "Dec 18 8:23PM")
                            HStack {
                                Spacer()
                        ...
                        ZStack{
                            CourseFileView(image: "PDF", name: "sw10tutorial-model.pdf", time: "Dec 28 7:56PM")
                            HStack {
                                Spacer()
                                Image(systemName: "arrow.down.circle.fill")
                                    .font(.title3)
                        ...
                        ZStack{
                            CourseFileView(image: "ZIP", name: "coursework22023.rar", time: "Dec 22 8:23AM")
                            HStack {
                                Spacer()
                                Image(systemName: "arrow.down.circle.fill")
                                    .font(.title3)
                        ...
                        ZStack{
                            CourseFileView(image: "PDF", name: "zycdut-introduction.pdf", time: "Dec 21 7:23PM")
                            HStack {
                                Spacer()
                                Image(systemName: "arrow.down.circle.fill")
                                    .font(.title3)
                        ...
                        ZStack{
                            CourseFileView(image: "PDF", name: "w10tutorialnew-model.pdf", time: "Nov 2 8:23PM")
                            HStack {
                                Spacer()
                                Image(systemName: "arrow.down.circle.fill")
                                    .font(.title3)
...
struct Course_DB_View_Previews: PreviewProvider {
