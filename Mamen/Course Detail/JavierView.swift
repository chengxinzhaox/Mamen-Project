            ...
            VStack {
                HStack {
                    VStack(alignment: .leading) {
                        ...
                        Text("Innovation Product Development")
                            .font(.system(size: 15))
                            .offset(y: 4)
                            .fontWeight(.medium)
                            ...
                            HStack {
                                ...
                                Text("@JavierJia")
                                    ...
                                    .sheet(isPresented: $showWebView) {
                                        SafariView(url: URL(string: "https://www.feishu.cn")!)
                                    }
                            }
                        }
                        HStack {
...
struct JavierView_Previews: PreviewProvider {
